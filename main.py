...
while run:
    bet_value = int(input("Enter the amount of coin you want to bet: "))
    ...
    if slot_1[s1_value] == slot_2[s2_value] == slot_3[s3_value] == '7':
    ...
    elif slot_1[s1_value] == slot_2[s2_value] == slot_3[s3_value] == "Apple":
        print(f"YOU GOT 7 7 7 IN THE LOWER ROW")
        point = point + (bet_value*2)
        print(f"you win {bet_value*2} coins.")
    elif slot_1[s1_value] == slot_2[s2_value] == slot_3[s3_value] == "Orange":
        print(f"YOU GOT 7 7 7 IN THE UPPER ROW")
        point = point + (bet_value*2)
        print(f"you win {bet_value*2} coins.")
    elif (s1_value == 0 and s2_value == 1 and s3_value == 2) or (s1_value == 2 and s2_value == 1 and s3_value == 0):
    ...
    if (point > 0):
        ...
        play_again = input("Press Y/y if you want to play again  or press N/n if you want to quit: ")
